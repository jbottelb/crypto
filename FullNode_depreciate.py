...
def try_start_mining_new_block(currently_mining, transactions_being_mined, miners, pending_transactions, connections, blockchains_collection):
    '''
...
def handle_message(sock, message, neighbors, miners,blockchains_collectionn, connections,
                  orphan_blocks, pending_transactions, block_hashes_seen_before,
...
def ping_nodes(nodes: set, self_address: tuple):
    ...
    for node in nodes_to_remove:
        print(f"Discarding inactive connection: {node}")
        nodes.discard(node)
